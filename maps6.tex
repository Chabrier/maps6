...
%
% DevLog 2013 - Presentation MAPS-6
%
...
\titlegraphic{%
  \includegraphics[width=2cm]{Logotype-INRA}
  \hspace{.5cm}
  \includegraphics[width=1.5cm]{MIA_logo}
  \hspace{.5cm}
  \includegraphics[width=2cm]{logo_RECORD-gris}
  \hspace{.5cm}
  \includegraphics[width=2cm]{yellowvle}
}
...
% % use case défavorables

% \section{Remaining slides from the previous presentation}
