% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
%
% Copyright (c) 2013 Gauthier Quesnel - quesnel@users.sourceforge.net
%
...
\documentclass[xetex, compress, table, dvipsnames]{beamer}
\usepackage{fontspec}
\usepackage{xltxtra}
...
\setbeamercolor{alerted text}{fg=RawSienna}
