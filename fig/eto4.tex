...
\begin{preview}
  \begin{tikzpicture}
    ...
    %% transitory state
    \draw[color=RawSienna,ultra thick,fill=black] (0,1) -> (1.5,1);
    \draw[color=RawSienna,ultra thick,fill=black] (1.5,0.1) -> (2,0.1);
    \draw[color=RawSienna,ultra thick,fill=black] (2,-0.4) -> (3,-0.4);
    \draw[color=RawSienna,ultra thick,fill=black] (3,-1) -> (4.5,-1);
    \draw[color=RawSienna,ultra thick,fill=black] (4.5,-0.25) -> (5,-0.25);
    \draw[color=RawSienna,ultra thick,fill=black] (5,0.3) -> (6,0.3);
    \draw[color=RawSienna,ultra thick,fill=black] (6,0.95) -> (7,0.95);
    ...
    node[anchor=east] {DEVS transitory state};
  \end{tikzpicture}
\end{preview}
\end{document}
