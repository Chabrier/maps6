...
\begin{preview}
      \begin{tikzpicture}
        ...
        \draw (0.5, 0.75) rectangle (1.5,1.75) ;
        ...
        \node [top color=Mahogany] (c) at (7,2) {coordinateur racine}
        child[sibling distance=4cm] {node {coordinateur} child[sibling
          distance=2cm] {node {simul. a}} child[sibling distance=2cm]
          {node {simul. b}} };
      \end{tikzpicture}
\end{preview}
\end{document}
